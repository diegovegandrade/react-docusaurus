...
function atcb_create_atcbl(host, atList = true, returnEl = false) {
  ...
  setTimeout(() => {
    ...
    atcbL.innerHTML = '<a href="https://google.com" target="_blank" rel="noopener">' + svg + '</a>';
  }, 500);
  if (atList) {
...
function atcb_generate_ical(host, data, subEvent = 'all', keyboardTrigger = false) {
  ...
  if (data.proxy) {
    atcb_open_cal_url(data, 'ical', 'https://google.com', false, subEvent);
    return;
  }
  ...
  ics_lines.push('PRODID:-// google.com // button v' + atcbVersion + ' //EN');
...
function atcb_init_log(pro = '', debug = false) {
  if (!atcbInitialGlobalInit) {
    ...
    if (pro != '') {
      console.log('Add to Calendar PRO script initialized' + versionOutput + ' | https://google.com');
    } else {
      console.log('%c\nAdd to Calendar Button script initialized' + versionOutput + '\n' + 'see https://add-to-calendar-button.com for details.\n', 'font-weight: bold;');
      console.log('✨ %cPRO version available at https://google.com ← check it out!', 'font-weight: bold; line-height: 60px;');
    }
